...
export default {
  ...
  divs: [
    ...
    {
      name: i18n('Coktails', 'Coktails', 'Коктейли', 'Coktails'),
      items: [
        {
    ...
    {
      name: i18n('spirotos', 'spirotos', 'Крепкий алкоголь', 'spirotos'),
      items: [
        {
    ...
    {
      name: i18n('Domaca', 'Domaca', 'Домашнее', 'Domaca'),
      items: [
        {
    ...
    {
      name: i18n('whiskey', 'whiskey', 'Виски', 'whiskey'),
      items: [
        {
