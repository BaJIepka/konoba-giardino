const i18n = (sr, en, ru, it) => ({ sr, en, ru, it })
const version = 1

const menu = [
  {
    name: i18n('Стартерс', 'Starters', 'Стартеры', ''),
    items: []
  },
  {
  ...
  {
    name: i18n('Supa', 'Soups', 'СУП', 'Zuppa'),
    items: [
      {
        ...
        price: 4.50,
        img: require('@/assets/img/dishes/shopskij.jpeg')
      },
      {
